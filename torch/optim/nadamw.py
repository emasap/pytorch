...
__all__ = ['NAdamW', 'nadamw']

class NAdamW(Optimizer):
    def __init__(self, params, lr=2e-3, betas=(0.9, 0.999), eps=1e-8,
                 weight_decay=1e-2, momentum_decay=4e-3, *, foreach: Optional[bool] = None,
...
NAdamW.__doc__ = r"""Implements NAdamW algorithm.
...
def nadamw(params: List[Tensor],
    ...
    See :class:`~torch.optim.NAdamW` for details.
    """
...
def _single_tensor_nadamw(params: List[Tensor],
                          grads: List[Tensor],
                          exp_avgs: List[Tensor],
                          exp_avg_sqs: List[Tensor],
                          mu_products: List[Tensor],
...
def _multi_tensor_nadamw(params: List[Tensor],
                         grads: List[Tensor],
                         exp_avgs: List[Tensor],
                         exp_avg_sqs: List[Tensor],
                         mu_products: List[Tensor],
