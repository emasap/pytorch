...
class TestReductions(TestCase):
    ...
    def test_sum_non_contiguous(self, device, dtype) -> None:
        def helper(self, shape, reduce_dims, device, dtype):
            ...
            dim1 = torch.randint(1, len(shape), (1,)).item()
            dim2 = torch.randint(0, len(shape), (1,)).item()
            dim2 = dim1 - 1 if dim1 == dim2 else dim2

            x_trans = x.transpose(dim1, dim2)
        ...
        for shape, dims in [
                            ...
                            ((10, 128, 300, 300), (0, 1)),
                            ((10, 128, 300, 300), (0, 1, 2)), ((10, 128, 300, 300), (0, 1, 2, 3)),
                            ((10, 55, 600), (0)), ((10, 55, 600), (0, 1)), ((10, 55, 600), (0, 1, 2)),
                            ((10, 55, 600, 66, 7), (0)), ((10, 55, 600, 66, 7), (0, 1)), ((10, 55, 600, 66, 7), (0, 1, 2)),
                            ((10, 55, 600, 66, 7), (0, 1, 2, 3)), ((10, 55, 600, 66, 7), (0, 1, 2, 3, 4)),
                            ((10, 55, 600, 66, 7), (0, 3)), ((10, 55, 600, 66, 7), (0, 2)),
                            ((10, 55, 600, 66, 7), (2, 3)), ((10, 55, 600, 66, 7), (1, 3)),
                            ((10, 55, 600, 66, 7), (1, 4)), ((10, 55, 600, 66, 7), (2, 4)),
                            ]:
